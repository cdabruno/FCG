...
GLuint BuildTriangles()
{
    ...
    {
        NDC_coefficients[4 * i] = 0.7 * cos(angle);
        NDC_coefficients[4 * i + 1] = 0.7 * sin(angle);
        NDC_coefficients[4 * (i + 1)] = 0.5 * cos(angle);
        NDC_coefficients[4 * (i + 1) + 1] = 0.5 * sin(angle);
        angle += increment;
    }
    ...
    for (int i = 0; i < 32; i += 2)
    {
        ...
        color_coefficients[4 * (i + 1)] = 1.0f;
        color_coefficients[4 * (i + 1) + 1] = 0.0f;
        color_coefficients[4 * (i + 1) + 2] = 0.0f;
    }
